...
class Ui_MainWindow(object):
	...
	def displayToScreen(self, data):
		...
		for name, typeAttraction, summary, duration, start, cost in data:
			...
			attractionWidget.setTextOnAllLabel('Name :          ' + name, 'Type :           '+typeAttraction,'Duration  :    '+str(duration)+' min','Start time :   '+str(start)+' hrs','Cost :            '+str(cost),'Summary :    '+summary)
...
################################################
	def retranslateUi(self, MainWindow):
		...
		self.airlinesButton.setStatusTip(_translate("MainWindow", "Search for Airlines"))
		self.movieButton.setText(_translate("MainWindow", "Movies"))
		self.movieButton.setStatusTip(_translate("MainWindow", "Search for Movies"))
		self.attractionButton.setText(_translate("MainWindow", "Attractions"))
		self.attractionButton.setStatusTip(_translate("MainWindow", "Search for Attractions"))
		self.RestaurantButton.setText(_translate("MainWindow", "Restaurants"))
		self.RestaurantButton.setStatusTip(_translate("MainWindow", "Search for Restaurants"))
